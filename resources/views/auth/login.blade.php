...
<section class="bg-green-900 font-inter flex items-center justify-center min-h-screen">
    <div class="p-8 w-full max-w-xl">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="flex justify-between text-sm text-green-200 mb-4">
                <p>* Min. 8 Karakter</p>
                <a href="{{ route('password.request') }}" class="text-green-200">Lupa Password?
                    <b class="underline">Klik disini</b>
                </a>
            </div>
        ...
        <p class="text-green-200 flex justify-center text-sm mt-10">© {{ date('Y') }} WargaSimpel, Web. All rights
            reserved.</p>
    </div>
</section>
